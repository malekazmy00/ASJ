...
class AIService:
    ...
    def _call_gemini_with_retry(cls, part_number: str, image_base64: Optional[str] = None,
        ...
        - "Compatible_Model": الجهاز/الموديل المتوافق
        - "Additional_Compatibility": توافقية إضافية إن وجدت
        - "Market_Value": القيمة السوقية التقديرية
        - "Gemini_Insights": ملاحظات فنية موجزة بالعربية الفصحى، واذكر هنا لو رقم القطعة أو الاسم غير مؤكدين
